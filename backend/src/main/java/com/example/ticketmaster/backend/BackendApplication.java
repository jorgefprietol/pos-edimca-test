...
public class BackendApplication {
	...
	public CommandLineRunner init(EventRepository eventRepo, UserRepository userRepo){
		return args -> {
		    ...
		    User user = createUser(userRepo, event1, "Jorge", "Prieto", "jorgefprietol@gmail.com", 38);
		};
	}
    ...
    private ApiInfo apiDetails() {
	    return new ApiInfo(
	            "POS Backend API",
                "API for EDIMCA test Backend",
                "1.0",
                "Free to use",
                new springfox.documentation.service.Contact("jorge prieto", "jorgefprietol@gmail.com", "jorgefprietol@gmail.com"),
                "API License",
                "",
